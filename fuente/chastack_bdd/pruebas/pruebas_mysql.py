...
def crearBaseDeDatos():
    ...
    try:
        ...
        print("[MySQL]\t\tBase de datos y usuario creados con éxito.")
...
def crearYPoblarTablas():
    ...
    try:
        ...
        conn.commit()
        print("[MySQL]\t\tTodas las tablas se han creado correctamente.")
    ...
    try:
        ...
        conn.commit()
        print("[MySQL]\t\t¡Inserciones completadas con éxito!")
...
def destruirBaseDeDatos():
    ...
    try:
        ...
        cursor.execute("FLUSH PRIVILEGES;")
        print("[MySQL]\t\tBase de datos y usuario eliminados con éxito.")
    except mysql.connector.Error as err:
        print("Error:", err)
    finally:
        if conn.is_connected():
...
class PruebaRegistros_MySQL(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
...
class PruebaUsuario_MySQL(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.bdd = BaseDeDatos_MySQL(CONFIG_BDD_PRUEBAS)
...
class PruebaTablaIntermedia_MySQL(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.bdd = BaseDeDatos_MySQL(CONFIG_BDD_PRUEBAS)
